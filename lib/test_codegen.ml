...
[@@expect.uncaught_exn {|
  ...
  Raised at Novac__Codegen.codegen_decl in file "lib/codegen.ml", line 785, characters 9-57
  Called from Novac__Codegen.codegen_stmt in file "lib/codegen.ml", line 788, characters 31-50
