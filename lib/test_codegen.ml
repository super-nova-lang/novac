...
[@@expect.uncaught_exn {|
  ...
  Raised at Novac__Codegen.codegen_decl in file "lib/codegen.ml", line 1004, characters 9-57
  Called from Novac__Codegen.codegen_stmt in file "lib/codegen.ml", line 1036, characters 31-50
